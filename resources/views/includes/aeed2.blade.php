...
<style>
  .djdj{display: flex;justify-content: center;}
 .j{display: flex;justify-content:center; font-size:25px;}
.button {
  padding: 15px 25px;
  font-size: 24px;
  text-align: center;
...
<div style="   background-image: url('images2/carousel_7.jpg');
...
border-width:2px 2px;
  ...
  <p class='caption'>                 مشروع الاضاحي لعام 2020م                   </p>
  </div>
...
أحد اعمال المنظمة المختلفة و هي الاضاحي
...
تم أعداد المواشي و توزيعها علي الاجئيين
...
تم توزيع الاضاحي بالتنسيق مع منظمة الاخوة
